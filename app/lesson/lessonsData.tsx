...
export const lessonsIdx = [
  ...
  },
  {
    ...
    pic: hacking,
    materi:
      "Hacking secara bahasa dapat diartikan sebagai peretasan, hacking sendiri pada dasarnya merupakan suatu aktivitas yang dilakukan secara ilegal ke dalam suatu sistem komputer dan jaringan. Orang yang melakukan tindakan hacking disebut juga dengan istilah hacker, hacker sendiri merupakan orang-orang yang memiliki keterampilan mendetail dalam sistem komputer atau tentang pemrograman komputer dan mereka menggunakan keterampilan tersebut untuk membobol sistem dalam suatu perangkat",
    materiLanjut:
      "Selanjutnya adalah cracking, cracking merupakan istilah yang masih berkaitan erat dengan istilah hacking. Sama halnya dengan aktivitas hacking, cracking merupakan aktivitas ilegal yang dilakukan oleh pihak",
    avoidance: [
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. 1",
